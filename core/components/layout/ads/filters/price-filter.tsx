...
export const PriceFilterContent = () => {
    ...
    return (
        <View className="border border-primary-500 px-4 py-12 rounded-xl" style={{ direction: isRTL ? "rtl" : "ltr" }}>
            <Text className="text-lg font-semibold text-gray-700">{t("advancedSearch.priceRange")}</Text>

            <View className='flex-row gap-2 items-center justify-center mt-4'>
                <Text className="flex-1 border border-gray-100 rounded-md p-2 font-semibold text-gray-700">{t("advancedSearch.min")}</Text>
                <Text className="flex-1 border border-gray-100 rounded-md p-2 font-semibold text-gray-700">{t("advancedSearch.max")}</Text>
            </View>
