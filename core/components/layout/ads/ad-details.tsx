                ...
                <View className="px-4">
                    <View className="gap-y-2 py-1">
                        ...
                        <View className="flex-row items-center justify-between">
                            ...
                            <Text className="font-inter-semibold text-lg dark:text-white">${adDetail.price || 0}</Text>
                        </View>
                    ...
                    <View className="border-y border-gray-200 gap-y-2 py-3">
                        <View className="flex-row items-center justify-between">
                            ...
                            <Text className="font-inter text-xs text-gray-400">{new Date(adDetail.created_at).toLocaleDateString()}</Text>
                        </View>
                        <AdSpecifications>
                            <View className="border border-primary-500 rounded-md items-center justify-center py-1 px-2 w-[103px]">
                                <Text className="font-inter-semibold dark:text-white">{adDetail.year || new Date().getFullYear()}</Text>
                                <Text className="dark:text-white">{t("year")}</Text>
                            </View>
                            <View className="border border-primary-500 rounded-md items-center justify-center py-1 px-2 w-[103px]">
                                <Text className="font-inter-semibold dark:text-white">{t(`unit.${adDetail.mileage_unit || 'KM'}`)}</Text>
                    ...
                    <View className="gap-y-1 py-3">
                        <View className="flex-row items-center justify-between">
                            ...
                            <Text className="font-inter text-xs text-gray-400">{adDetail.id}</Text>
                        </View>
