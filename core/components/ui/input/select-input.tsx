...
export default function SelectInput<TForm extends FieldValues>({
  onChangeText,
  control,
  name,
  error,
  ...
  return (
    <View className="w-full">
      {label && (
        <Text className="text-base font-semibold pl-6 mb-1 dark:text-white text-black">
          {label}
        </Text>
      )}
      <Pressable onPress={() => setShowModal(true)}>
        <View
          className={clsx(
            "flex-row items-center border dark:border-primary-500",
            {
