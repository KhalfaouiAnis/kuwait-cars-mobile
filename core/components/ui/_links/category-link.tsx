...
export default function CategoryLink({ href, image, label, params, fullWidth = false }: Props) {
    return (
        <Link href={{ pathname: href, params }} className={`items-center justify-center ${fullWidth ? "w-full" : "w-[31%]"} h-36 p-2 border border-primary-500 rounded-xl bg-white dark:bg-darkish elevation-xl`}>
