import SearchItem from "@/core/components/layout/ads/search/search-item";
import ProfileHeader from "@/core/components/layout/header/profile-header";
import Container from "@/core/components/ui/container";
import { Ad_CATEGORIES } from "@/core/constants/ad";
import useAdvancedSearchStore from "@/core/lib/stores/advanced-search-store";
import useUserPreferencesStore from "@/core/lib/stores/preferences.store";
import { AntDesign, Ionicons, MaterialCommunityIcons, Octicons } from "@expo/vector-icons";
import { Pressable, ScrollView, Text, TouchableOpacity, View } from "react-native";

export default function SearchScreen() {
    const { setFilterValue, ad_type } = useAdvancedSearchStore()
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                    {
                        Ad_CATEGORIES.map(category => (
                            <Pressable key={category} onPress={() => setFilterValue("ad_type", category)}>
