        ...
        <Container header={<MainHeader drawer back={false} />}>
            <ScrollView style={{ marginBottom: 80 }} showsVerticalScrollIndicator={false}>
                <View className="mt-4 mx-2 flex-row justify-center gap-3 flex-wrap">
                    <CategoryLink href="/categories/4f5f4/" image={IMAGES.BrakesCategory} label="Used cars" />
                    ...
                    <CategoryLink href="/categories/4f5f4/" image={IMAGES.BMW3SeriesE46Category} label="Show car" />
                    <CategoryLink href="/categories/4f5f4/" image={IMAGES.ZerexG05PhosphateCategory} label="Car Rental Agencies" />

                    <CategoryLink href="/categories/4f5f4/" image={IMAGES.BMW3SeriesE46Category} label="Part car" />
                    <CategoryLink href="/categories/4f5f4/" image={IMAGES.CarAccessoriesCategory} label="Home services for car" />
                    ...
                    <CategoryLink href="/categories/4f5f4/" image={IMAGES.BlackHawkStreetHU01UHPCategory} label="Winch + External charging" />
