    ...
    const renderItem = ({ item }: {
        ...
        return (
            <Swipeable
                ...
                friction={2}
                leftThreshold={40}
                renderLeftActions={(progress) => <LeftAction progress={progress} handleDelete={() => {
                    setSelectedItemId(item.id)
                    setShowDeleteDialog(true)
                }} />}
            >
                <View className="rounded-lg p-1 flex-row items-center mb-4 mx-1 border-gray-400 border bg-white dark:bg-darkish">
                    <Image
                        ...
                        <View className="flex-1 justify-evenly">
                            {
                                activeTab === "COMPLETED" ? (
                                    ...
                                    <TouchableOpacity className="bg-error items-center py-1 px-3 mb-1 rounded-lg"
                                        onPress={() => {
                                            setSelectedItemId(item.id)
                                            setShowDeleteDialog(true)
                                        }}
